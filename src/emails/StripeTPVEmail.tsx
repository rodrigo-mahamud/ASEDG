...
export default function StripeTPVEmail({ nombre }: any) {
  return (
    <Tailwind>
            ...
            <Column className="bg-white py-8 border border-[#ddd] rounded-xl shadow-lg">
              <Section className="px-12">
                <Heading className="mt-0" as="h1">
                  {nombre} hemos revocado tu acceso al gimnasio municipal.
                </Heading>
                ...
                <Text className="bg-[#f0f3f7] text-center rounded py-7 text-3xl tracking-[6px] font-semibold my-6"></Text>
