...
export default async function NewsMainPage() {
  try {
    ...
    console.error('Error al cargar la página principal de instalacciones deportivas:', error)
    return <div>Error al cargar la página principal de instalacciones deportivas</div>
  }
}
