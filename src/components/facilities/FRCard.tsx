      ...
      {data.facilitieImages && (
        ...
        >
          <div className="flex relative w-full h-full items-end transitionAlt hover:rounded-xl rounded-lg overflow-hidden">
            ...
            <div className="absolute z-10 p-4 md:p-6 flex flex-col items-start w-full translate-y-4 group-hover:translate-y-0 transition-generic">
              <div className="flex justify-between w-full mb-2"></div>
              <div className="w-full">
                <h2 className="text-white line-clamp-1 md:line-clamp-2 font-semibold text-lg transition-generic">
                  {data.title}
                </h2>
