...
export default async function SDCards({ className, logType }: any) {
  const activityLogs = await getRevenue('year', logType)

  return (
    <Card className={className}>
      <CardHeader className="flex flex-row items-center justify-between space-y-0 pb-2">
        <CardTitle className="text-base font-medium mb-1">Total Revenue</CardTitle>
